...
class AboutController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $data->mission_details = $request->mission_details;
        $data->vission_details = $request->vission_details;
        $data->body_about_description = $request->body_about_description;
        $data->body_about_title = $request->body_about_title;
        ...
        $body_about_image = $request->body_about_image;
        if ($body_about_image) {
            @unlink($data->body_about_image);
            $uniqname = uniqid();
            $ext = strtolower($body_about_image->getClientOriginalExtension());
            $filepath = 'public/frontend/images/about/';
            $imagename = $filepath . $uniqname . '.' . $ext;
            $body_about_image->move($filepath, $imagename);
            $data->body_about_image = $imagename;
        }
