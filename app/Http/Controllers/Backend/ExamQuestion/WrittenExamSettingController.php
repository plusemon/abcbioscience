...
class WrittenExamSettingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['questions'] = $query->whereNull('deleted_at')->where('fee_cat_id',5)->latest()->paginate(100);
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('backend.questions.written_question_setting.edit', $data);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(WrittenExamSetting $writtenExamSetting,$id)
    {
        

 
        $findexamsettingcount       = ExamSetting::where('id',$id)->where('fee_cat_id',5)->count();
 
 
        if($findexamsettingcount>0)
        {

             $findexamsetting  = ExamSetting::where('id',$id)->where('fee_cat_id',5)->first();
  
             $feeamountcount = FeeAmountSetting::where('fee_cat_id',5)->where('origin_id',$id)->count();
         
             $findstudentmcqsetting = StudentQuestionSetting::where('exam_setting_id',$id)->where('fee_cat_id',5)->count();
            ...
            {
                StudentQuestionSetting::where('exam_setting_id',$id)->where('fee_cat_id',5)->delete();
            }
