...
class McqQuestionSettingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['questions'] = $query->whereNull('deleted_at')->where('fee_cat_id',4)->latest()->paginate(100);
    ...
    {   
        ...
        if($findexamsettingcount>0)
        {
            ...
            McqExamStudentAnsSummary::where('mcq_exam_setting_id',$id)->delete();
            ...
            ResultGroup::where('mcq_exam_setting_id',$findexamsetting->id)->delete();
