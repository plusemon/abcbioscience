...
class AttendanceController extends Controller
{
    ...
    public function attendancepresentexport($id)
    {

        $data['attendance']  = Attendance::find($id);
        $pdf = PDF::loadView('backend.attendances.attendance_present_pdf',$data);
        return $pdf->download('student_present_attendance_list.pdf');
    } 


    public function attendanceabsentexport($id)
    {
        $data['attendance']  = Attendance::find($id);
        $pdf = PDF::loadView('backend.attendances.attendance_absent_pdf',$data);
        return $pdf->download('student_absent_attendance_list.pdf');
    }
