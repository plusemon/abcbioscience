        ...
        // {
            ...
            )
            {
                ...
                )
                {
                    ...
                    return redirect()->back()->with([$notification,'error','Student already added!']);
                }
            }
            ...
            $student->student_type_id       = $request->batch_type_id;
            ...
            {
                $previousStudent = Student::where('user_id',$student->user_id)
