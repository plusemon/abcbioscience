...
class WrittenQuestion extends Model
{
	...
	protected $fillable = ['question_no', 'class_id', 'session_id', 'subject_id', 'chapter_id', 'topic', 'examination_type_id', 'total_mark' ,'attachment', 'description', 'status', 'deleted_at'];
