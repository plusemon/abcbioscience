...
Route::group(['namespace' => 'Backend\Student', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('student/folder/class','StudentController@studentclass')->name('student.folder.class');

    Route::get('student/folder/batch/{id}','StudentController@studentbatch')->name('student.folder.batch');

    Route::get('student/folder/batch/student/{id}','StudentController@studentbatchstudent')->name('student.folder.batch.student');
