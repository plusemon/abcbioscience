...
@section('title', 'Diagram Exam History')
@section('content')
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Diagram Exam History</h4>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($exams as $exam)
                                        <tr>
                                            ...
                                            <td> {{ optional($exam->diagramQuestionSubjects)->question_no }} </td>
                                            ...
                                            @if ($exam->diagramresult)
                                                <td> {{ $exam->diagramresult->created_at->format('d-m-Y') }}</td>
                                                <td>{{ $exam->diagramresult->result ?? 'Pending' }}</td>
                                            @else
                                                <td></td>
                                                <td class="text-danger">Missed</td>
                                            @endif
                                            <td> 
                                            <a href="{{ asset($exam->diagramexam?$exam->diagramexam->attachment:'') }}"
