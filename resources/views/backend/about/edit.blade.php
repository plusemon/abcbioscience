                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="py-2">
                                                                            ...
                                                                            <br>
                                                                            <img src="{{asset($about->mission_image)}}" alt="" width="300">
                                                                            <br>
                                                                        ...
                                                                        <div class="py-2">
                                                                            ...
                                                                            <br>
                                                                            <img src="{{asset($about->vission_image)}}" alt="" width="300">
                                                                            <br>
                                                                        ...
                                                                        <div class="py-2">
                                                                            <label for="">Footer About<span class="text-danger"></span></label>
                                                                            <textarea name="footer_about"  class="form-control summernote" placeholder="Footer About">{{$about->footer_about}}</textarea>
                                                                            <div class="text-danger">{{ $errors->first('footer_about') }}</div>
                                                                        </div>

                                                                        <div class="py-2">
                                                                            <label for="">Body About Heading <span class="text-danger"></span></label>
                                                                            <input name="body_about_title" value="{{ $about->body_about_title }}"  class="form-control" placeholder="Body About Heading">
                                                                            <div class="text-danger">{{ $errors->first('body_about_title') }}</div>
                                                                        </div>
                                                                        <div class="py-2">
                                                                            <label for="">Body About Description <span class="text-danger"></span></label>
                                                                            <textarea name="body_about_description"  class="form-control summernote" placeholder="Body About Description">{{$about->body_about_description}}</textarea>
                                                                            <div class="text-danger">{{ $errors->first('body_about_description') }}</div>
                                                                        </div>
                                                                        <div class="py-2">
                                                                            <label for="">Body About image <span class="text-danger"></span></label>
                                                                            <input type="file" class="form-control" name="body_about_image">
                                                                            <div class="text-danger">{{ $errors->first('body_about_image') }}</div>
                                                                        </div>
