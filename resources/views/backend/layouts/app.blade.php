...
<body>
    ...
    <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
        <div id="header" class="header navbar-default">
            <div class="navbar-header"> <a href="{{ route('home') }}" class="navbar-brand"><span
                        class="navbar-logo"></span>
                    <b> {{ $websetting->site_name }} </b> &nbsp; Admin</a>
                <button type="button" class="navbar-toggle" data-click="sidebar-toggled"> <span
                        class="icon-bar"></span>
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown navbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="{{ route('user.profile') }}" class="dropdown-item"><i class="fa fa-user"></i>
                            Profile</a>
                        <a href="{{ route('user.setting') }}" class="dropdown-item"><i class="fa fa-cogs"></i>
                            Setting</a>
        ...
        <div id="sidebar" class="sidebar">
            <div data-scrollbar="true" data-height="100%">
                ...
                <ul class="nav">
                    ...
                    @can('student setting')
                        <li class="has-sub">
                            <a href="javascript:;"> <b class="caret"></b> <i class="fa fa-list-ol"></i>
                                <span>Students
                                    Setting </span>
                            </a>
                            <ul class="sub-menu">
                                <li><a href="{{ route('classes.index') }}"> Class <i
                                            class="fa fa-plus text-theme"></i></a></li>
                                <li><a href="{{ route('sessiones.index') }}"> Session <i
                                            class="fa fa-list text-theme"></i> </a>
                                </li>
                                {{-- <li><a href="{{ route('batch.index') }}"> Batch <i class="fa fa-list text-theme"></i> </a></li> --}}
                                <li><a href="{{ route('section.index') }}"> Section <i class="fa fa-list text-theme"></i>
                                    </a></li>
                                <li><a href="{{ route('year.index') }}"> Year <i class="fa fa-list text-theme"></i> </a>
                                </li>
                                <li><a href="{{ route('subject.index') }}"> Subject <i class="fa fa-list text-theme"></i>
                                    </a></li>
                                <li><a href="{{ route('chapter.index') }}"> Chapter <i class="fa fa-list text-theme"></i>
                                    </a></li>
                                <li><a href="{{ route('batch.schedule.index') }}"> Batch list <i
                                            class="fa fa-list text-theme"></i>
                                    </a></li>
                            </ul>
                        </li>
                    @endcan
                    @can('student management')
                        <li class="has-sub">
                            ...
                            <ul class="sub-menu">
                                <li><a href="{{ route('student.index') }}"> Student List <i
                                            class="fa fa-plus text-theme"></i></a>
                                </li>
                                <li><a href="{{ route('student.folder.session') }}"> Student Folder <i
                                ...
                                <li><a href="{{ route('student.user.index') }}"> Student User List <i
                                            class="fa fa-plus text-theme"></i></a></li>
                               <li><a href="{{ route('student.non.errol.users') }}"> Non Enrolled User List <i
                                           class="fa fa-plus text-theme"></i></a></li>
                                <li><a href="{{ route('student.create') }}"> Add Student <i
                                            class="fa fa-list text-theme"></i> </a>
                                </li>
                    ...
                    @can('attendance')
                        <li class="has-sub">
                            <a href="javascript:;"> <b class="caret"></b> <i class="fa fa-clipboard"></i>
                                <span>Attendance
                                </span>
                            </a>
                            <ul class="sub-menu">
                    ...
                    @can('fee management')
                        <li class="has-sub">
                            <a href="javascript:;"> <b class="caret"></b> <i class="fa fa-list-ol"></i> <span>Fee
                                    Management
                                </span>
                            </a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="{{ route('admin.fee-amount-setting.index') }}"> Fee Batch Wise Setting <i
                                            class="fa fa-plus text-theme"></i></a></li>
                                <li><a href="{{ route('admin.fee-collection.index') }}"> Fee Collection list<i
                                            class="fa fa-list text-theme"></i></a></li>
                                <li><a href="{{ route('admin.fee-collection.create') }}">Monthly Fee Collection <i
                                            class="fa fa-plus text-theme"></i></a></li>
                                ...
                                <li><a href="{{ route('admin.student.due.invoice.list') }}">Monthly Due Invoice List <i
                                                                            class="fa fa-list text-theme"></i></a></li>

                                <li><a href="{{ route('admin.student.payment.pending.list') }}">Payment Verify Pending <i
                                                                            class="fa fa-list text-theme"></i></a></li>
                    ...
                    @can('written qustions')
                        <li class="has-sub">
                            ...
                            <ul class="sub-menu">
                                <li><a href="{{ route('admin.diagramquestion.index') }}">Diagram Question List<i
                                            class="fa fa-list text-theme"></i></a></li>
                                <li><a href="{{ route('admin.diagramquestion.create') }}">Create Diagram Question<i
                                            class="fa fa-plus text-theme"></i></a></li>
                                <li><a href="{{ route('admin.diagram-setting.index') }}">Diagram Q Setting List<i
                                            class="fa fa-list text-theme"></i></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="sub-menu">
                                <li><a href="{{ route('mcqoffline.index') }}">Offline MCQ Question List<i
                                            class="fa fa-list text-theme"></i></a></li>
                                <li><a href="{{ route('mcqoffline.create') }}">Create Offline MCQ Question<i
                                            class="fa fa-plus text-theme"></i></a></li>
                                <li><a href="{{ route('admin.mcqoffline-setting.index') }}">Offline MCQ Q Setting List<i
                                            class="fa fa-list text-theme"></i></a></li>
                            </ul>
                        </li>
                    ...
                    @can('result management')
                        <li class="has-sub">
                            <a href="javascript:;"> <b class="caret"></b> <i class="fa fa-clipboard"></i> <span>
                                    Result
                                    Management </span></a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="{{ route('admin.mcq.exam.results.index') }}">MCQ Result <i
                                            class="fa fa-list text-theme"></i> </a></li>
                                <li><a href="{{ route('admin.diagram.exam.results.index') }}">Diagram Result <i
                                            class="fa fa-list text-theme"></i> </a></li>
                                
                                <li><a href="{{ route('admin.offlinemcq.exam.results.index') }}">Offline MCQ Result <i
                                            class="fa fa-list text-theme"></i> </a></li>
                                            
                                            
                                <li><a href="{{ route('admin.result.group.index') }}">Group Result<i
                                            class="fa fa-plus text-theme"></i></a></li>
                                <li><a href="{{ route('extraexamgroup.index') }}">Extra Exam Group<i
                                            class="fa fa-plus text-theme"></i></a></li> 
                                <li><a href="{{ route('extraexam.index') }}">Extra Exam Result<i
                                            class="fa fa-plus text-theme"></i></a></li>
                            </ul>
                        </li>
                    @endcan
                    @can('old questions')
                        <li class="has-sub">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="{{ route('old.subject.index') }}">Subject<i class="fa fa-list text-theme"></i> </a></li>
                                <li><a href="{{ route('ebooks.index') }}">Ebook<i class="fa fa-list text-theme"></i> </a></li>

                               <li><a href="{{ route('old_school.schools.index') }}">Old Questions <i
                                            class="fa fa-list text-theme"></i> </a></li>
                                <li><a href="{{ route('old_school.boards.index') }}">Board questions <i
                                            class="fa fa-list text-theme"></i> </a></li>
                            </ul>
                        </li>
                    ...
                    @can('sheet management')
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="sub-menu">
                                <li><a href="{{ route('sheet.index') }}">Sheets List<i
                                            class="fa fa-plus text-theme"></i></a></li>
                                <li><a href="{{ route('sheet.create') }}">Add Sheet <i
                                            class="fa fa-list text-theme"></i> </a>
                                </li>
                    ...
                    @can('sms settting')
                        ...
                        <li class="has-sub">
                            <a href="javascript:;"> <b class="caret"></b> <i class="fa fa-envelope"></i>
                                <span>SMS Setting
                                </span>
                            </a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="{{ route('batch.sms') }}"> Batch SMS <i class="fa fa-list text-theme"></i>
                                    </a></li>
                                <li><a href="{{ route('single.sms') }}"> Single SMS <i
                                            class="fa fa-list text-theme"></i> </a>
                                </li>
                                <li><a href="{{ route('custom.batch.sms') }}"> Custom Batch SMS<i
                                            class="fa fa-list text-theme"></i> </a></li>
                                <li><a href="{{ route('sms_history.index') }}"> SMS Reports <i
                                            class="fa fa-list text-theme"></i>
                                    </a></li>
                            </ul>
                        </li>
                    ...
                    @can('website settting')
                        ...
                        <li class="has-sub">
                            <a href="javascript:;"> <b class="caret"></b> <i class="fa fa-cogs"></i>
                                <span>Website
                                    Settings </span>
                            </a>
                            <ul class="sub-menu">
                                <li><a href="{{ route('slider.index') }}"> Sliders <i class="fa fa-share"></i> </a>
                                </li>
                                <li><a href="{{ route('notice.index') }}"> Notices <i class="fa fa-share"></i> </a>
                                </li>
                                <li><a href="{{ route('social.index') }}"> Social Media <i class="fa fa-share"></i>
                                    </a></li>
                                <li><a href="{{ route('website.setting.index') }}"> Web Setting <i
                                            class="fa fa-cogs text-theme"></i> </a></li>
                                <li><a href="{{ route('blog.index') }}"> Blogs <i class="fa fa-cogs text-theme"></i>
                                    </a></li>
                                <li><a href="{{ route('user.index') }}"> User Management <i
                                            class="fa fa-cogs text-theme"></i>
                                    </a></li>
    ...
    <script src="{{ asset('public/backend') }}/assets/plugins/summernote/dist/summernote.min.js" type="text/javascript">
    </script>
