    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Edit Quiz Question </h4>
            ...
            <div class="panel-body">
                <form action="{{ route('quizquestion.update',$quizquestion->id) }}" method="post" enctype="multipart/form-data">
                    @CSRF
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="quiz_id" id="quiz_id" class="class_id form-control" >
                                    ...
                                    @foreach($quizzes as $quiz)
                                        <option {{ $quizquestion->quiz_id == $quiz->id ? 'selected' :'' }} value="{{ $quiz->id }}"> {{ $quiz->quiz_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="question_name" value="{{ $quizquestion->question_name }}" class="form-control" placeholder="Enter Question">
                      ...
                      <div class="row">
                        ...
                        @foreach($quizquestion->QuizQuestionValue as $option)

                        <div class="col-xs-12 col-sm-5 col-md-5">
                            <div class="form-group">
                                 <input type="text" name="option_name[]" value="{{  $option->option_name }}" class="form-control" placeholder="Options 01">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5">
                            <div class="form-group">
                                 <select name="answer[]" id="" class="form-control" >
                                    <option {{ $option->answer == 0 ? 'selected' : '' }} value="0">Incorrect Answer</option>
                                    <option {{ $option->answer == 1 ? 'selected' : '' }} value="1">Correct Answer</option>
                                </select>
