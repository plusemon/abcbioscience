                    ...
                    <tbody>
                        ...
                        @foreach ($subject->questions as $question)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('old_school.board_questions.show', $question->id) }}"
                                       download="">{{ $question->name }}</a>
                                </td>
                                ...
                                <td>
                                    ...
                                    <button onclick="setEditModal({{ $question }})" type="button" data-toggle="modal"
                                        ...
                                        <form action="{{ route('old_school.board_questions.destroy', $question->id) }}" method="POST"
    ...
    <div class="modal fade" id="addNewModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('old_school.board_questions.store') }}" enctype="multipart/form-data"
                      method="POST">
...
@push('js')
    <script>
        function setEditModal({
            ...
            // declare the vars
            let route = `{{ route('old_school.board_questions.index') }}/${id}`
