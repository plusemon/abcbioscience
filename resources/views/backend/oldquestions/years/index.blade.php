                ...
                <table id="laravel_datatable" class="table table-striped table-bordered table-td-valign-middle">
                    ...
                    @foreach($years as $year)
                        <tr>
                            ...
                            <td>{{$year->name}}</td>
                            <td>
                                <a href="{{route('year.show',$year->id)}}" class="btn btn-success">view</a>
                                <a href="{{route('year.edit',$year->id)}}" class="btn btn-primary">edit</a>
                                <a href="{{route('year.destroy',$year->id)}}" id="delete" class="btn btn-danger">delate</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
