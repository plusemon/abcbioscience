                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="quiz_name" value="{{ old('quiz_name') }}" class="form-control" placeholder="Quiz Name">
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="quiz_time" value="{{ old('quiz_time') }}" class="form-control" placeholder="Quiz time">
                        ...
                        <div class="col-xs-12 col-sm-9 col-md-9">
                            <div class="form-group">
                                ...
                                <textarea name="quiz_description" type="text" id="quiz_description" class="form-control" placeholder="Enter Quiz Description">{{ old('quiz_description') }}</textarea>
