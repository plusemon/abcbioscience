                ...
                <div class="panel-body">
                    <form action="{{ route('sheet.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sheet_no" value="{{ old('sheet_no') }}" class="form-control" placeholder="Enter Sheet Name" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">   
                                <div class="form-group">
                                    <label for="sheet_type_id">Sheet Type :</label>
                                    <select name="sheet_type_id" id="sheet_type_id" class="form-control" required>
                                        <option value="">Select Session</option>
                                        @foreach($sheetTypies as $sheet)
                                            <option {{ old('sheet_type_id') == $sheet->id ? 'selected' :'' }} value="{{ $sheet->id }}"> {{ $sheet->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="text-danger">{{ $errors->first('sheet_type_id') }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-12 col-lg-12">   
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control summernote" placeholder="Enter Sheet description"></textarea>
