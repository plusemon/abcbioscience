...
@section('title', 'Diagram Exam Absend Students SMS')
@section('content')

    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Send SMS to Diagram exam absent students</h4>
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('diagram.result.sms') }}" method="POST">
                    @csrf
                    ...
                    <input type="hidden" name="test_name" value="{{ optional($exam->diagramQuestionSubjects)->question_no}}">
                    <input type="hidden" name="subject_name" value="{{ optional($exam->diagramQuestionSubjects)->topic}}">
