                    ...
                    <div class="row" >
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" value="" name="exam_start_date_time" class="form-control" required/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" value="" name="exam_end_date_time" class="form-control" required/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('duration') }}" name="duration" placeholder="Enter Exam Duration Time" class="form-control" required/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ old('amount') }}" name="amount" step="any" class="form-control" placeholder="Amount"/>
