...
@section('title','Diagram Exam Setting ')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Diagram Exam Setting Edit </h4>
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('admin.written-setting.update', $setting->id ) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="row" >
