...
@section('title','Diagram Questions')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Diagram Questions  </h4>
            ...
            <div class="panel-body">
                ...
                <a href="{{ route('admin.diagramquestion.create') }}" class="btn btn-primary btn-sm float-right mb-1" id="create-new-class"><i class="fa fa-plus"></i> Add Diagram Question</a>
                ...
                <table id="laravel_datatable" class="table table-striped table-bordered table-td-valign-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.diagramquestion.edit',$question->id) }}" class="btn btn-primary btn-sm"> Edit</a>

                                <a href="{{ route('admin.diagram-setting.create','qid='.$question->id) }}" class="btn btn-primary btn-sm"> Setting</a>

                                <form action="{{ route('admin.diagramquestion.destroy',$question->id)  }}" method="post">
                                    @csrf
                                    @method('DELETE')
