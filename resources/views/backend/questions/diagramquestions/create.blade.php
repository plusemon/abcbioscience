...
@section('title','Add New Diagram Questions')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Add New Diagram Questions  </h4>
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('admin.diagramquestion.store') }}" method="post" enctype="multipart/form-data">
                    @CSRF
