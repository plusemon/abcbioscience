...
@section('title','Edit Offline MCQ Exam Setting ')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Edit Offline MCQ Exam Setting Edit </h4>
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('admin.mcqoffline-setting.update', $setting->id ) }}" method="post">
                    @csrf
                    @method('put')
                    <div class="row" >
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="datetime-local"  value="{{ $setting->exam_start_date_time }}" name="exam_start_date_time" class="form-control" required/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" value="{{ $setting->exam_end_date_time }}" name="exam_end_date_time" class="form-control" required/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $setting->duration }}" name="duration" class="form-control" required/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <select name="fee_cat_id" id="fee_cat_id" class="form-control" required>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <select name="pay_time_id" id="pay_time_id" class="form-control" required>
                                    ...
                                    <option {{ $setting->amounts->pay_time_id == $paytime->id ? 'selected' :'' }} value="{{ $paytime->id }}">{{ $paytime->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $setting->amounts->amount }}" name="amount" step="any" class="form-control" placeholder="Amount"/>
