...
@section('title','Offline MCQ Questions List')
@section('content')

    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Offline MCQ Questions List </h4>
                    ...
                    @foreach($questions as $question)
                        <tr>
                            ...
                            <td class="d-flex btn-group">
                                    <a href="{{ route('admin.mcqoffline-setting.edit', $question->id) }}?qid={{ $question->question_subject_id }}"
                                        class="btn btn-outline-success btn-sm d-flex align-items-center "> <i
                                            class="fa fa-edit"></i> Edit</a>
                                    <a href="{{ route('admin.mcqoffline-setting.destroy',$question->id)}}"
