...
@section('title','Offline MCQ Exam Setting ')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Offline MCQ  Exam Setting </h4>
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('admin.mcqoffline-setting.store') }}" method="post">
                    @csrf
                    <div class="row" >
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" value="{{ old('exam_start_date_time') }}" name="exam_start_date_time" class="form-control" required/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" value="{{ old('exam_end_date_time') }}" name="exam_end_date_time" class="form-control" required/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="duration" placeholder="Enter Exam Duration Time" class="form-control" required/>
