                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4">
                            <div class="form-group">
                                <label for="Subject">Chapter : </label>
                                  <input type="text" disabled value="{{   $question->chapter?$question->chapter->name:'' }}" class="form-control">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" disabled name="topic" value="{{ $question->topic }}" placeholder="Chapter topic" class="form-control" >
                                ...
                                <div style="margin-bottom:10px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            @if ($mcqQes->image)
                                                <img   src="{{ url($mcqQes->image) }}" alt="Image" style="width: 500px;padding: 20px">
                                            @endif
                                        </div>
                                    </div>
                                </div>
