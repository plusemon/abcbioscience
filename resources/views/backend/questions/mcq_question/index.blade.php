    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <a href="{{ route('admin.mcq.create') }}" class="btn btn-primary btn-sm float-right mb-1"
                    id="create-new-class"><i class="fa fa-plus"></i> Add Question</a>
                     ...
                     <form action="" method="get" class="form-inline mb-3">
                        ...
                        <button type="submit" id="search_id" class="btn btn-primary btn-sm"> <i class="fa fa-search"></i>  Search</button>
...
@section('customjs')
    ...
    <script>
      ...
      <script>
            ...
            {
                var url =  "{{ route('admin.mcq.ajax.index') }}";
                ...
                $.ajax({
                    url: url,
                    type: "GET",
                    data: {pagination:pagination,subject_id:subject_id,class_id:class_id,session_id:session_id,chapter_id:chapter_id},
            ...
            function getPagination(pageNumber){
                var createUrl = "{{ route('admin.mcq.ajax.index') }}";
