...
@section('title','Edit Mcq Offline Questions')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Edit Mcq Offline Questions  </h4>
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('mcqoffline.update',$question->id) }}" method="post" enctype="multipart/form-data">
                    @CSRF
                    @method('PUT')
