                     ...
                     <div class="form-group">
                        ...
                        <select name="board_name_id" id="board_name_id" class="form-control">
                            @foreach($boardnames as $board)
                                <option {{ $old_qus->board_name_id == $board->id ? 'selected' : '' }} value="{{ $board->id }}"> {{ $board->name }}</option>
                            @endforeach
                        </select>
                    </div>
                      <div class="form-group">
                        <label for="subject">Subject :</label>
                        <input type="text" class="form-control" value="{{ $old_qus->subject_id }}" name="subject_id" placeholder="Enter subject">
                        @error('subject')
