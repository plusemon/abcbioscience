...
@section('title','College Old Questions')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">College Old Questions  </h4>
            ...
            <div class="panel-body">
                ...
                <a href="{{ route('old_question.college.create') }}" class="btn btn-primary btn-sm float-right mb-1" id="create-new-class"><i class="fa fa-plus"></i> Add College Question</a>
                ...
                <table id="laravel_datatable" class="table table-striped table-bordered table-td-valign-middle">
                    ...
                    <tr>
                        ...
                        <th class="text-nowrap">College Name</th>
                    ...
                    @foreach($old_quss as $old_qus)
                        <tr>
                            <td>{{$loop->index+1}}</td>
                            <td>{{ $old_qus->school?$old_qus->school->name:''  }} </td>
                           ...
                           <td>
                            ...
                            <td>
                                <a href="{{route('old_question.college.edit',$old_qus->id)}}" class="btn btn-primary btn-sm"> <i class="fa fa-edit"></i> Edit</a>
                                <a href="{{route('old_question.college.destroy',$old_qus->id)}}" id="delete" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> Delate</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
