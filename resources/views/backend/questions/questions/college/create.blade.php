            ...
            <div class="panel-body">
                <form action="{{ route('old_question.college.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="schoolname" id="schoolname" class="form-control" placeholder="Enter College Name">
                        @error('schoolname')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="subject_id" placeholder="Enter Subject" class="form-control" />
                    </div>
