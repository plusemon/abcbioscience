...
@section('title','Diagram Student Question Setting')
@section('content')

    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Diagram Student Question Setting </h4>
                ...
                <table id="laravel_datatable" class="table  table-responsive table-striped table-bordered table-td-valign-middle">
                    ...
                    @foreach($questions as $question)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.written.question.student.setting.create','qtype=diagram&qid='.$question->id)}}" class="btn btn-success btn-sm ">
                                    <small>View</small>
                                </a>
