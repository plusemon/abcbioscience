...
@section('title','Diagram Student Exam Setting ')
@section('content')
    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Diagram Student Exam Setting </h4>
            ...
            <div class="panel-body">
               ...
               <form action="{{ route('admin.diagram.question.student.setting.store') }}" method="post">
                            @csrf
                    <div class="row" >
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-5">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="question_subject_id" value="{{$written_question_subject_id}}" name="mcq_question_subject_id" />
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" disabled @if($question) value="{{ date('d-m-Y',strtotime($question->exam_start_date_time))}}" @endif class="form-control"/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" disabled @if($question) value="{{ date('d-M-Y h:i:s a',strtotime($question->exam_end_date_time))}}" @endif class="form-control"/>
