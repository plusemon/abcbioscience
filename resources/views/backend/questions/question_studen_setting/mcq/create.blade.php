        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                    ...
                    @endif
                     ...
                     <form action="{{ route('admin.mcq.question.student.permission.store') }}" method="post">
                            @csrf
                    ...
                    <div class="row" >
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-5">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="question_subject_id" value="{{$mcq_question_subject_id}}" name="mcq_question_subject_id" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="subject_id" value="{{$mcq_subject_id}}" name="mcq_subject_id" />
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" disabled @if($question) value="{{ date('d-m-Y h:i:s A',strtotime($question->exam_start_date_time))}}" @endif class="form-control"/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" disabled @if($question) value="{{ date('d-m-Y h:i A',strtotime($question->exam_end_date_time))}}" @endif class="form-control"/>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" disabled @if($question) value="{{  $question->duration }} Minutes" @endif class="form-control"/>
                    ...
                    <div class="row" style="margin-top:3%;" id="studentList">
                        ...
                        <table id="laravel_datatable" class="table table-striped table-bordered table-td-valign-middle">
                            ...
                            <tr>
                                ...
                                <input type="hidden" class="mcqCreateStudentList"  value="{{route('admin.mcq.question.student.setting.create.student.list')}}" />
                                <input type="hidden" class="mcqStoreStudent"  value="{{route('admin.mcq.question.student.setting.store')}}" />
...
@section('customjs')
      ...
      <script>
        ...
        function getAllStudentByBatchAndBatchType()
        {
            ...
            var url                 = $('.mcqCreateStudentList').val();
            $.ajax({
                    type: "get",
                    url: url,
                    data: {class_id:class_id,session_id:session_id,batch_setting_id:batch_setting_id,batch_type_id:batch_type_id,exam_setting_id:exam_setting_id},
