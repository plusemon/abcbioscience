    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Mcq Student Question Setting </h4>
                ...
                <table id="laravel_datatable" class="table  table-responsive table-striped table-bordered table-td-valign-middle">
                    ...
                    @foreach($questions as $question)
                        <tr>
                            ...
                            <td>{   { date('d-m-Y',strtotime($question->examSettings?$question->examSettings->exam_start_date_time :NULL ))}}</td>
                            <td>{{ date('h:i:s a',strtotime($question->examSettings?$question->examSettings->exam_start_date_time :NULL ))}}</td>
                            <td>{{ date('h:i:s a',strtotime($question->examSettings?$question->examSettings->exam_end_date_time :NULL ))}}</td>
