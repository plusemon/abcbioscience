...
<input type="hidden" id="getHtmlResponse" data-url="{{route('admin.student.waiver.index.ajax')}}" >
      ...
      <script>
            ...
            function getHtmlResponse()
            {
                ...
                $.ajax({
                    url: url,
                    type: "GET",
                    data: {pagination:pagination,student_id:student_id,class_id:class_id,session_id:session_id,batch_setting_id:batch_setting_id},
                    success: function(response)
                    {
