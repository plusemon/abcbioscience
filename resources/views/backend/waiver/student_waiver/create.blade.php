...
@section('title','Add Student Waive')
@section('content')
                ...
                <div class="col-xl-12">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-10">
                        <div class="panel-heading">
                            <h4 class="panel-title">Add Student Waiver</h4>
                        ...
                        <div class="panel-body">
                            <form action="{{ route('admin.student-waiver.store') }}" method="POST" >
                                @csrf
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="fee_cat_id" id="" class="fee_cat_id form-control" required>
                                                    ...
                                                    <option {{ old('fee_cat_id') == $feeCat->id ? 'selected' : '' }} value="{{ $feeCat->id }}">
                                                        {{ $feeCat->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="waiver_id" id="" class="waiver_id form-control" required>
                                                    ...
                                                    <option {{ old('waiver_id') == $waiver->id ? 'selected' : '' }} value="{{ $waiver->id }}">
                                                        {{ $waiver->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="end_month_id" id="" class="end_month_id form-control" required>
                                                    ...
                                                    @foreach($months as $month)
                                                    <option {{ old('end_month_id') == $month->id ? 'selected' : '' }} value="{{ $month->id }}">
                                                        {{ $month->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
