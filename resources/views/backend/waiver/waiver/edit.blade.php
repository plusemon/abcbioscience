    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('admin.waiver.update',$waiver->id) }}" method="post">
                    @CSRF
                    @method('PUT')
                    <div class="row" >
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="name" value="{{$waiver->name}}" name="name" class="form-control" placeholder="Name"/>
                            ...
                            <div class="form-group">
                                ...
                                <select name="waiver_type_id" id="class_id" class="form-control" required>
                                    ...
                                    @foreach($waiverTypes as $webtype)
                                        <option {{ $waiver->waiver_type_id == $webtype->id ? 'selected' :'' }} value="{{ $webtype->id }}"> {{ $webtype->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{$waiver->amount}}" name="amount" class="form-control"/>
