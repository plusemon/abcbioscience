            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <input type="hidden" id="searchingStudentByAjax"
                            value="{{ route('admin.get_student_by_key_up') }}" />
                        ...
                        <div class="form-group dropdown">
                            ...
                            <input type="text" id="p_name_sku_bar_code_id" value="" autocomplete="off"
                                class="form-control studentName" placeholder="Student name">
                        ...
                        <div class="form-group">
                            ...
                            <select name="current_class_id" class="current_class_id form-control">
                                ...
                                @foreach ($classes as $class)
                                    <option {{ $current_class_id == $class->id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="current_session_id" class="current_session_id form-control">
                                ...
                                @foreach ($sessiones as $session)
                                    <option {{ $current_session_id == $session->id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="batch_type_id" class="current_batch_type_id form-control">
                                ...
                                @foreach ($batchTypes as $btype)
                                    <option {{ $batch_type_id == $btype->id ? 'selected' : '' }}
                                        value="{{ $btype->id }}">{{ $btype->name }}</option>
                                @endforeach
                            </select>
        ...
        $(document).ready(function() {
            ...
            */
            ...
            $(document).on('change keyup',
                '.dropdown_class,.studentName, .student_id,.current_class_id,.current_session_id,.current_batch_setting_id,.current_batch_type_id,.action_type',
                function() {
            ...
            function sendRequest(chaeckAble) {
                ...
                if (chaeckAble == true) {
                    if (action_type == 2) {
                        if (user_id && current_class_id && current_session_id && current_batch_setting_id &&
                            current_batch_type_id && action_type) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        current_batch_setting_id: current_batch_setting_id,
                        current_batch_type_id: current_batch_type_id,
