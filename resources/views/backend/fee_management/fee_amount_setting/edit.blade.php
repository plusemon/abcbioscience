    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Edit Batch Wise Fee Amount Setting   </h4>
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('admin.fee-amount-setting.update',$feeAmountSetting->id) }}" method="post">
                    @CSRF
                    @method('PUT')
                    <div class="row" >
                            ...
                            <div class="form-group">
                                ...
                                <select name="fee_cat_id"  class="form-control" required>
                                    ...
                                    @foreach($fee_categories as $feeCat)
                                        <option {{ $feeAmountSetting->fee_cat_id == $feeCat->id ? 'selected' :'' }} value="{{ $feeCat->id }}"> {{ $feeCat->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="class_id"  class="class_id form-control" required>
                                    ...
                                    @foreach($classes as $class)
                                        <option {{ $feeAmountSetting->class_id == $class->id ? 'selected' :'' }} value="{{ $class->id }}"> {{ $class->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="session_id" id="" class="session_id form-control" required>
                                    ...
                                    @foreach($sessiones as $session)
                                        <option {{ $feeAmountSetting->session_id == $session->id ? 'selected' :'' }} value="{{ $session->id }}"> {{ $session->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <select name="batch_setting_id" id="" class="batch_setting_id form-control" required>
                                     ...
                                     <option {{ $feeAmountSetting->batch_setting_id == $item->id ? 'selected' :'' }}  value="{{$item->id}}">{{$item->batch_name}}</option>
                                     @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="batch_type_id" id="batch_type_id" class="batch_type_id form-control" required>
                                    ...
                                    @foreach($batchTypies as $batchType)
                                        <option {{ $feeAmountSetting->batch_type_id == $batchType->id ? 'selected' :'' }} value="{{ $batchType->id }}"> {{ $batchType->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="fee_category_action_type_id" id="" class="fee_category_action_type_id form-control" required>
                                        ...
                                        <option {{ $feeAmountSetting->fee_category_action_type_id == $feeAction->id ? 'selected' :'' }} value="{{ $feeAction->id }}">{{ $feeAction->name }}</option>
                                        @endforeach
                                </select>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="section_id" id="section_id" class="form-control" required>
                                        ...
                                        <option {{ $feeAmountSetting->section_id  == $section->id ? 'selected' :'' }} value="{{ $section->id }}">{{ $section->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <select name="pay_time_id" id="pay_time_id" class="form-control" required>
                                     ...
                                     <option {{ $feeAmountSetting->pay_time_id == $paytime->id ? 'selected' :'' }} value="{{ $paytime->id }}">{{ $paytime->name }}</option>
                                     @endforeach
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{$feeAmountSetting->amount}}" name="amount" class="form-control"/>
