    ...
    <div id="content" class="content">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <h4 class="panel-title">Add Batch Wise Fee Amount Setting  </h4>
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('admin.fee-amount-setting.store') }}" method="post">
                    @CSRF
                    <div class="row" >
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                <label for="class">Fee Category :</label>
                                <select name="fee_cat_id" id="class_id" class="form-control" required>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="fee_category_action_type_id" id="" class="fee_category_action_type_id form-control" required>
                                        ...
                                        <option {{ old('fee_category_action_type_id') == $feeAction->id ? 'selected' :'' }} value="{{ $feeAction->id }}">{{ $feeAction->name }}</option>
                                        @endforeach
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" value="" step="any" name="amount" class="form-control" placeholder="Amount"/>
                                <div class="text-danger">{{ $errors->first('amount') }}</div>
                            </div>
                        </div>
                        <input type="hidden" value="NULL" name="origin_id" class="form-control"/>
