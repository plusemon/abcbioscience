    ...
    @section('title','Add Others Fee Collection')
    @section('content')
                    ...
                    <div class="col-xl-12">
                        <div class="panel panel-inverse" data-sortable-id="form-stuff-10">
                            <div class="panel-heading">
                                <h4 class="panel-title">Others Fee Collection</h4>
                            ...
                            <div class="panel-body">
                                <form action="{{ route('admin.storeOthersFeeCollectionByStudent') }}" method="POST" >
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2" id="transaction_id">
                                            <div class="form-group">
                                                <label >Transaction ID</label>
                                                <input type="text" class="form-control" name="transaction_id" placeholder="Enter Bkash Transaction ID">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="reference_no" class="reference_no"/>
