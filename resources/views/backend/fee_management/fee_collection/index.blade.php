      ...
      <script>
            ...
            function getHtmlResponse()
            {
                ...
                $.ajax({
                    url: url,
                    type: "GET",
                    data: {pagination:pagination,fee_cat_id:fee_cat_id,student_id:student_id,class_id:class_id,session_id:session_id,batch_setting_id:batch_setting_id,month_id:month_id},
                    success: function(response)
                    {
