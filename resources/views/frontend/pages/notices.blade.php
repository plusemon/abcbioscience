								...
								<table class="table table-bordered table-hovered">
									...
									<tbody>
										...
										<tr>
											...
											<td>{{ $notice->title }}</td>
											<td><a href="{{ asset($notice->noticesfile) }}" title="{{ $notice->title }}" download=""  class="btn btn-primary btn-sm"> <i class="fa fa-download"></i> Download</a>
										    <a href="{{ route('notice.detail',$notice->slug) }}" title="{{ $notice->title }}" class="btn btn-sm btn-info text-white"> <i class="fa fa-eye"></i> View</a>
											</td>
