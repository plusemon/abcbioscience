        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-5">
                    <div class="batch_box">
                        <h5><span>Batch Enrollment </span></h5>
                        <hr>
                        ...
                        <hr>
                        <div class="batch_day">
                            <p>Days of Class <span class="float-right btn btn-sm btn-primary">{{ $batchsetting->classtype?$batchsetting->classtype->name:'' }}</span></p>
                            ...
                            <form action="{{ route('student.batch.admission') }}" method="post">
                                ...
                                <input type="hidden" class="form-control" name="transaction_id" value="" placeholder="Enter Bkash/Rocket Transaction ID/Last 4 digits" required>
