					...
					<div class="registation">
						<form action="{{ route('student.password.forgot.send') }}" method="post">
							...
							<div class="form-group">
 							 ...
 							 <button type="submit" class="btn btn-primary mt-4"><i class="fa fa-sign-in"></i> Reset</button>
 
							<p class="pt-3">Have account? <a class="btn btn-primary btn-sm" href="{{ route('student.register') }}">Login</a></p>
						</form>
					</div>
				</div>
			</div>
